...
def solution(cards1, cards2, goal):
    cards1_dq = deque(cards1)
    cards2_dq = deque(cards2)
    goal_dq = deque(goal)

    while True:
        if goal_dq:
            top_goal = goal_dq.popleft()
        else:
            return "Yes"
        if cards1_dq and top_goal == cards1_dq[0]:
            cards1_dq.popleft()
        elif cards2_dq and top_goal == cards2_dq[0]:
            cards2_dq.popleft()
        else:
            return "No"
...
class ProgrammersTest(unittest.TestCase):
    def testSolution1(self):
        param1 = ["i", "drink", "water"]
        param2 = ["want", "to"]
        param3 = ["i", "want", "to", "drink", "water"]
        result = solution(param1, param2, param3)
        self.assertEqual(result, "Yes")

    def testSolution2(self):
        param1 = ["i", "water", "drink"]
        param2 = ["want", "to"]
        param3 = ["i", "want", "to", "drink", "water"]
        result = solution(param1, param2, param3)
